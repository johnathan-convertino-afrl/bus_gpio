...
\input{src/fusesoc/depend_wishbone_classic_gpio.tex}
...
\input{src/fusesoc/files_wishbone_classic_gpio.tex}
...
\input{src/fusesoc/targets_wishbone_classic_gpio.tex}
