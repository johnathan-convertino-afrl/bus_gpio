...
\input{src/fusesoc/depend_axi_lite_gpio.tex}

\input{src/fusesoc/depend_wishbone_standard_gpio.tex}

\input{src/fusesoc/depend_up_gpio.tex}
...
\input{src/fusesoc/files_axi_lite_gpio.tex}

\input{src/fusesoc/files_wishbone_standard_gpio.tex}

\input{src/fusesoc/files_up_gpio.tex}

\subsection{Targets}

\input{src/fusesoc/targets_axi_lite_gpio.tex}

\input{src/fusesoc/targets_wishbone_standard_gpio.tex}

\input{src/fusesoc/targets_up_gpio.tex}
